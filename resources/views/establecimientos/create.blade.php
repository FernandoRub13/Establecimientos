...
@section('content')
<div class="container">
  <h1 class="text-venter mt-4">Registrar establecimiento</h1>
  <div class="mt-5 row justify-content-center">
    ...
    >
      ...
      <fieldset class="border p-4">
        <legend class="text-primary">Nombre y categoría e imagen del estabelcimiento</legend>
        ...
        <div class="form-group">
          ...
          <input required id="imagen_principal" type="file" class="form-control @error('imagen_principal') is-invalid @enderror"
