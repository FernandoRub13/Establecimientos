...
<div class="mapa">
  ...
  >
    ...
    :icon="obtenerIcono(establecimiento)"
...
export default {
  ...
  data() {
    return {
      zoom: 13,
      center: latLng(19.4369082,-99.153345),
      url: "https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png",
      attribution:
        '&copy; <a href="http://osm.org/copyright">OpenStreetMap</a> contributors',
      currentZoom: 11.5,
      currentCenter: latLng(19.4369082, -99.1533459),
      showParagraph: false,
      mapOptions: {
        zoomSnap: 0.5
      },
  ...
  watch: {
    "$store.state.categoria": function () {
      axios.get('/api/categoria/'+ this.$store.getters.getCategoria)
      .then(response => {
        this.$store.commit('AGREGAR_ESTABLECIMIENTOS', response.data);
      })
    }
