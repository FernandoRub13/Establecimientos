  ...
  <div class="container my-5">
    ...
    <div class="row">
      <div class="col-md-4 mt-4" v-for="restaurante in this.restaurantes" v-bind:key="restaurante.id" >
        <div class="card">
          <img class="card-img-top" :src="`/storage/${restaurante.imagen_principal}`" alt="Imagen de restaurant" >
          <div class="card-body">
            <h3 class="card-title text-primary font-bold">{{restaurante.nombre}}</h3>
            <p class="card-text">{{restaurante.direccion}}</p>
            <p class="card-text">
              <span class="font-weight-bold">Horario:</span>
              <span>{{restaurante.apertura}} - {{restaurante.cierre}} </span>
            </p>
